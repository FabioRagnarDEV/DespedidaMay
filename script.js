...
function startMessagesAndMusic() {
    ...
    if (music1) {
        ...
        // Lógica para tocar a música 2 quando a 1 acabar
...
function triggerFourCorners() {
    createExplosion(15, 15); 
    createExplosion(85, 15); 
    createExplosion(15, 85); 
    createExplosion(85, 85); 
}
